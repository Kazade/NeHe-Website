...
class Article(models.Model):
    ...
    #FIXME: remove NULL after update
    article_type = models.CharField(max_length=32, choices=ARTICLE_TYPE_CHOICES, default='', blank=False, null=True)
    ...
    def save(self, *args, **kwargs):
        from articles.views import expire_view_by_url
        
        #Expire the Homepage cache if we have to
...
class UserProfile(models.Model):
    adsense_code = models.CharField(max_length=255, null=True, blank=True)
